...
@implementation WCCondition

+ (NSDictionary *)imageMap
{
    // Create a static NSDictionary since every instance of WCCondition will use the same data mapper.
    static NSDictionary *_imageMap = nil;
    if (!_imageMap) {
        // Map the condition codes to an image file
        _imageMap = @{
                      @"01d" : @"weather-clear",
                      @"02d" : @"weather-few",
                      @"03d" : @"weather-few",
...
// You only need to detail how to convert between Unix time and NSDate once.
